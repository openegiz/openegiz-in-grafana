...
The **OpenEgiz App Plugin** serves as the central frontend interface for the [OpenEgiz](https://github.com/openegiz/openegiz) platform. It connects your Grafana dashboard directly to the **Eclipse Ditto** core via our Extended API, providing a unified environment to manage, compose, and monitor your Digital Twins.
...
* **Extended API URL**
    * The base URL of the OpenEgiz middleware (Extended API).
...
* **User Guide:** For detailed instructions on how to use these features, visit the [OpenEgiz Official Documentation](https://openegiz.github.io/openegiz/docs/quickstart).
* **Source Code:** This project is Open Source. View the code or report issues on [GitHub](https://github.com/openegiz/openegiz-in-grafana).